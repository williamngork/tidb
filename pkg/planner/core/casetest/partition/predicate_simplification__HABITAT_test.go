...
func TestIssue62923(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		...
		tk.MustExec(`INSERT INTO tlfdfece63 (col_42, col_44) VALUES ('"test"', '1')`)
		tk.MustExec(`INSERT INTO tad03b424 (col_42, col_44, col_41) VALUES ('"test"', '1', '2020-01-01')`)

		// The query that triggers the assertion failure
		sql := `with cte_263 (col_1350, col_1351, col_1352) AS (
		select
			rpad(tad03b424.col_44, 6, tad03b424.col_48) as r0,
			insert(tlfdfece63.col_44, 0, 10, tlfdfece63.col_43) as r1,
			tad03b424.col_41 as r2
		from tlfdfece63, tad03b424
		where not(tlfdfece63.col_42 = '[\\"Sl9DRlDnSdIOxbfequ02VeikDWiphuDO6suBf0F7esJeCWrRJWQbd3BK3vT58Coz\\\\\\",\\\\\\"MmC5saHdTUqosY50IrxprAR52oD08XgGhqJCcYeoaDJKrYxBdbi0QuVDDArCghyL\\\\\\"]')
		order by r0, r1, r2
		limit 348170821
	)
