...
func TestPredicateSimplification__HABITAT(tt *testing.T) {
  ...
  UNIQUE KEY idx_15 (col_41,col_39,col_38)
		...
		testDataMap.LoadTestSuiteData("testdata", "predicate_simplification__HABITAT", true)
		suite := testDataMap["predicate_simplification__HABITAT"]
